        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
                <Grid container spacing={3}>
                    {/* Seção Perfil e Gráficos (Colunas da Esquerda e Direita) */}
